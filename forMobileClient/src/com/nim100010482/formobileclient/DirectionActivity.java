...
public class DirectionActivity extends FragmentActivity implements OnMyLocationChangeListener
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		if (b != null)
		{
			start = new LatLng(b.getDouble(PencarainLokasiActivity.KEY_LAT_ASAL), b.getDouble(PencarainLokasiActivity.KEY_LNG_ASAL));
			end = new LatLng(b.getDouble(PencarainLokasiActivity.KEY_LAT_TUJUAN), b.getDouble(PencarainLokasiActivity.KEY_LNG_TUJUAN));
			nama = b.getString(PencarainLokasiActivity.KEY_NAMA);
		}
	...
	{
		PolylineOptions line = new PolylineOptions().width(3).visible(true).color(Color.BLUE);
