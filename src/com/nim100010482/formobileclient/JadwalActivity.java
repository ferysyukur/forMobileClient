...
public class JadwalActivity extends ListActivity {
	...
	String kode="2";
	String link_url = "http://mobile-keudps.ml/mobile/jadwal-json2.php?kode"+kode;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		try {
			...
			for(int i = 0; i < jadwal.length(); i++){
				...
				String content = ar.getString(AR_KET_JADWAL).substring(0,10)+"...(baca selengkapnya)";
	...
	public void adapter_listview() {
		...
		lv.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,int position, long id) {
				...
				Intent in = new Intent(JadwalActivity.this, DetailJadwal.class);
