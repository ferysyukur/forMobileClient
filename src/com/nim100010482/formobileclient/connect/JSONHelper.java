package com.nim100010482.formobileclient.connect;
...
import com.nim100010482.formobileclient.Lokasi;
...
//    public final static int POST = 2;
	...
	private final String	TAG_LOKASI		= "lokasi";
    private final String	TAG_ID			= "id";
    private final String	TAG_ID_GRJ		= "id_grj";
	private final String	TAG_NM_GRJ		= "nm_grj";
	private final String	TAG_ALAMAT_GRJ	= "alamat_grj";
	private final String	TAG_LAT			= "latitude";
	private final String	TAG_LNG			= "longitude";
	private final String	TAG_KET_LOK		= "ket_lokasi";
	...
	public ArrayList<Lokasi> getLokasiAll(JSONObject jobj)
	{
		ArrayList<Lokasi> listLokasi = new ArrayList<Lokasi>();

		try
		{
			JSONArray arrayLokasi = jobj.getJSONArray(TAG_LOKASI);

			for (int i = 0; i < arrayLokasi.length(); i++)
			{
				JSONObject jobject = arrayLokasi.getJSONObject(i);

				Log.d("log", "muter ke " + i);
				listLokasi.add(new Lokasi(jobject.getInt(TAG_ID),jobject.getString(TAG_NM_GRJ), jobject.getString(TAG_ALAMAT_GRJ), jobject
						.getDouble(TAG_LAT), jobject.getDouble(TAG_LNG), jobject.getString(TAG_KET_LOK), jobject.getInt(TAG_ID_GRJ)));
